...
let package = Package(
    ...
    targets: [
        .target(
            ...
            path: "Sources/com.awareframework.ios.sensor.gyroscope"
        ),
        .testTarget(
            name: "com.awareframework.ios.sensor.gyroscopeTests",
            dependencies: ["com.awareframework.ios.core", "com.awareframework.ios.sensor.gyroscope"]
        )
    ],
