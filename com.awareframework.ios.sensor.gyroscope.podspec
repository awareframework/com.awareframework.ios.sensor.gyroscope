...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tetujin/com.awareframework.ios.sensor.gyroscope'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tetujin' => 'tetujin@ht.sfc.keio.ac.jp' }
  s.source           = { :git => 'https://github.com/tetujin/com.awareframework.ios.sensor.gyroscope.git', :tag => s.version.to_s }
